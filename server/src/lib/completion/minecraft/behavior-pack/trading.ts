...
export function provideCompletion(context: SimpleContext<CompletionBuilder>): void {
  ...
  //Vanilla data
  context.receiver.generate(MinecraftData.vanilla.BehaviorPack.trading, generatesDoc, Kinds.Completion.Trading);

  //Education data
  if (IsEducationEnabled(context.doc)) context.receiver.generate(MinecraftData.edu.BehaviorPack.trading, generatesDoc, Kinds.Completion.Trading);
}
