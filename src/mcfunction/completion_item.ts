...
export class McFunctionCompletion implements vscode.CompletionItemProvider {
  ...
  SelectorCompletion: Selector.SelectorCompletion;

  constructor() {
    this.SelectorCompletion = new Selector.SelectorCompletion();
  ...
  provideCompletionItems(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken, context: vscode.CompletionContext): vscode.ProviderResult<vscode.CompletionItem[] | vscode.CompletionList> {
    ...
    if (Line.isEmptyOrWhitespace || position.character == 0) return this.AllCommands;
